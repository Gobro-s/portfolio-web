  ...
  evidence: [
    {
      ...
      body: [
        ...
        "팀 배정 없이 혼자 맡아, Claude와 페어로 설계·구현했습니다.",
    ...
    },
    {
      ...
      body: [
        "2026년 7월, 이 사이트의 카드 이미지가 하나씩 뜨는 문제를 두고 AI가 네트워크 병렬처리를 원인으로 진단했습니다.",
        "브라우저에서 직접 측정해 보니 요청은 이미 병렬이었습니다. 진단을 정정시키고 실제 원인을 잡았습니다.",
        "같은 날 캡처 화면의 가독성 문제도 그 자리에서 지적해 되돌렸습니다.",
      ],
    },
    {
      title: "명세로 바꾸는 능력",
